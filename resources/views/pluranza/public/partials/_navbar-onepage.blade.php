            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="col-lg-8 col-md-7 col-sm-8">
                    <ul class="nav navbar-nav navbar-right ct-navbar--fadeIn">
                        ...
                        <li class="onepage"><a href="{{ route('pluranza.dancers.home') }}" class="white-nav-bar-textct-js-btnScroll">Bailarines</a></li>
                        <li class="onepage"><a href="{{ route('pluranza.competitors.home') }}" class="white-nav-bar-textct-js-btnScroll">Competidores</a></li>
