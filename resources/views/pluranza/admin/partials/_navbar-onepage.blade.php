            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="col-lg-8 col-md-7 col-sm-6">
                    <ul class="nav navbar-nav navbar-right ct-navbar--fadeIn">
                        ...
                        <li class="onepage"><a href="{{ route('pluranza.academies-participants.edit', $academyParticipant->id) }}" class="ct-js-btnScroll">Editar</a></li>
                        <li class="onepage"><a href="{{ route('pluranza.dancers.home', $academyParticipant->id) }}" class="ct-js-btnScroll">Miembros</a></li>
