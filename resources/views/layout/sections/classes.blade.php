<section id="section2" class="ct-u-paddingTop80 ct-u-paddingBottom90 section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-3">
                ...
                <div class="ct-u-paddingBottom20">
                    <div class="ct-owlSlider-title">
                        <h2 class="text-left ct-u-size28 ct-u-colorMotive ct-fw-400">Salsa</h2>
                        <span class="text-left">View all <a href="#">Salsa</a></span>
                    </div>
                </div>
            </div>
            <div class="col-md-9">
                            ...
                            <article class="ct-coursesBox">
                                <a href="#">
                                    <div class="ct-coursesBox-image">
                                        <img src="./assets/images/demo-content/salsa-coursesBox-1.jpg" class="grayscale grayscale-fade" alt="Team Member 1">
                    ...
                    <div class="item">
                        <div class="inner">
                            <article class="ct-coursesBox">
                                <a href="#">
                                    <div class="ct-coursesBox-image">
                                        <img src="./assets/images/demo-content/salsa-coursesBox-3.jpg" class="grayscale grayscale-fade" alt="Team Member 2">
                                        <div class="ct-coursesIcon">
                    ...
                    <div class="item">
                        <div class="inner">
                            <article class="ct-coursesBox">
                                <a href="#">
                                    <div class="ct-coursesBox-image">
                                        <img src="./assets/images/demo-content/salsa-coursesBox-2.jpg" class="grayscale grayscale-fade" alt="Team Member 3">
                                        <div class="ct-coursesIcon">
                    ...
                    <div class="item">
                        <div class="inner">
                            <article class="ct-coursesBox">
                                <a href="#">
                                    <div class="ct-coursesBox-image">
                                        <img src="./assets/images/demo-content/salsa-coursesBox-1.jpg" class="grayscale grayscale-fade" alt="Team Member 4">
                                        <div class="ct-coursesIcon">
                                            <div class="text-uppercase ct-fw-600 ct-u-paddingTop5">BEG</div>
                                            <div class="text-capitalize">Lvl1</div>
                                        </div>
                    ...
                    <div class="item">
                        <div class="inner">
                            <article class="ct-coursesBox">
                                <a href="#">
                                    <div class="ct-coursesBox-image">
                                        <img src="./assets/images/demo-content/salsa-coursesBox-2.jpg" class="grayscale grayscale-fade" alt="Team Member 5">
                                        <div class="ct-coursesIcon">
                                            <div class="text-uppercase ct-fw-600 ct-u-paddingTop5">BEG</div>
                                            <div class="text-capitalize">Lvl1</div>
                                        </div>
                    ...
                    <div class="item">
                        <div class="inner">
                            <article class="ct-coursesBox">
                                <a href="#">
                                    <div class="ct-coursesBox-image">
                                        <img src="./assets/images/demo-content/salsa-coursesBox-3.jpg" class="grayscale grayscale-fade" alt="Team Member 6">
                                        <div class="ct-coursesIcon">
                                            <div class="text-uppercase ct-fw-600 ct-u-paddingTop5">BEG</div>
                                            <div class="text-capitalize">Lvl1</div>
                                        </div>
